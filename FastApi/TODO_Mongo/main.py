...
# ------------------------------------------------------------
MONGO_URL = "mongodb+srv://aswinipolu003_db_user:iqsCUz6KP1eCKmyE@cluster0.we9p9dj.mongodb.net/todo_db?retryWrites=true&w=majority"
# MONGO_URL = "mongodb+srv://admin:admin123@cluster0.xxxxx.mongodb.net/todo_db?retryWrites=true&w=majority"
'''
mongodb+srv://aswinipolu003_db_user:<db_password>@cluster0.we9p9dj.mongodb.net/
...
def create_todo(todo: Todo):
    ...
    try:
        existing = TodoDB.objects.with_id(todo.id)

        if existing:
            raise HTTPException(
                status_code=400,
                detail=f"ID {todo.id} already exists"
            )
